...
const STATIC_ROUTES = [
  ...
  // ── SEO Expansion — 20 Flagship Pages (priority 1.0) ────────
  { path: "/market-crash-probability-2026",  changefreq: "daily",   priority: "1.0" },
  { path: "/market-crash-indicator",         changefreq: "daily",   priority: "1.0" },
  { path: "/recession-probability",          changefreq: "daily",   priority: "1.0" },
  { path: "/alt-season-indicator",           changefreq: "daily",   priority: "1.0" },
  { path: "/bitcoin-risk-dashboard",         changefreq: "daily",   priority: "1.0" },
  { path: "/ethereum-risk-dashboard",        changefreq: "daily",   priority: "1.0" },
  { path: "/stock/nvda",                     changefreq: "daily",   priority: "1.0" },
  { path: "/stock/pltr",                     changefreq: "daily",   priority: "1.0" },
  { path: "/stock/tsla",                     changefreq: "daily",   priority: "1.0" },
  { path: "/stock/meta",                     changefreq: "daily",   priority: "1.0" },
  { path: "/stock/amd",                      changefreq: "daily",   priority: "1.0" },
  { path: "/crypto/tao",                     changefreq: "daily",   priority: "1.0" },
  { path: "/federal-reserve-tracker",        changefreq: "daily",   priority: "1.0" },
  { path: "/liquidity-monitor",              changefreq: "daily",   priority: "1.0" },
  { path: "/volatility-dashboard",           changefreq: "daily",   priority: "1.0" },
  { path: "/ai-stocks-dashboard",            changefreq: "daily",   priority: "1.0" },
  { path: "/ai-stock-signals",               changefreq: "daily",   priority: "1.0" },
  { path: "/crypto-signals-intelligence",    changefreq: "daily",   priority: "1.0" },
  { path: "/market-regime-tracker",          changefreq: "daily",   priority: "1.0" },
...
export function registerSEORoutes(app: Express): void {
  ...
  app.get("/robots.txt", (_req, res) => {
    const content = [
      ...
      "Allow: /market-crash-probability-2026",
      "Allow: /market-crash-indicator",
      "Allow: /recession-probability",
      "Allow: /alt-season-indicator",
      "Allow: /bitcoin-risk-dashboard",
      "Allow: /ethereum-risk-dashboard",
      "Allow: /stock/",
      "Allow: /crypto/",
      "Allow: /federal-reserve-tracker",
      "Allow: /liquidity-monitor",
      "Allow: /volatility-dashboard",
      "Allow: /ai-stocks-dashboard",
      "Allow: /ai-stock-signals",
      "Allow: /crypto-signals-intelligence",
      "Allow: /market-regime-tracker",
