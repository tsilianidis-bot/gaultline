...
const SLIDES = [
  {
    icon: Activity,
    color: "#00D4FF",
    title: "Systemic Risk Scores",
    subtitle: "0–10 scale, live-computed",
    body: "Each domain — Credit, AI Bubble, Treasury, Liquidity, Inflation, Recession, Banking — is scored 0–10 using real FRED macroeconomic data. The composite drives the overall Systemic Risk score.",
  ...
  },
  {
    ...
    subtitle: "Bull vs. Crash · Recession · Stagflation",
    body: "Probabilities are derived from the weighted composite of all domain scores. They update in real time as FRED data refreshes. Bull and Crash always sum to 100%.",
    detail: "Higher systemic risk → higher crash probability. These are probabilistic estimates, not predictions.",
    detailColor: "#94A3B8",
  },
  {
    icon: AlertTriangle,
    ...
    body: "FAULTLINE classifies the current environment into one of five regimes: Low Risk, Moderate, Elevated Stress, Late-Cycle Fragility, or Critical Systemic Stress. The regime drives the color system across the entire app.",
    detail: "Regime changes are the most important signal to watch — they indicate a structural shift in macro conditions.",
    detailColor: "#FF9500",
  },
  {
    icon: Zap,
    ...
    subtitle: "Stress-test any scenario",
    body: "Use the Simulate tab to manually adjust any indicator — push VIX to 45, widen HY spreads to 600bps, or spike CPI — and watch every score, regime, probability, and narrative react in real time.",
    detail: "Simulation mode is clearly labeled. Tap Reset to return to live FRED data.",
    detailColor: "#C084FC",
  },
];
