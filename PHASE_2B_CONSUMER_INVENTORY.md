# Phase 2B Consumer Inventory

| Surface | Classification | Current source | Canonical state ID enforced | Action |
|---|---|---|---|---|
| NOW | CURRENT_CANONICAL | Canonical API plus presentation shell | Core score/regime | Complete full payload migration |
| WHY | CURRENT_CANONICAL | Canonical API; legacy narrative remains unreachable when canonical is absent | Core score/regime | Replace remaining legacy narrative/evidence projection |
| WATCH | CURRENT_CANONICAL | Canonical API; legacy monitoring projection remains unreachable when canonical is absent | Core score/regime | Replace remaining legacy monitoring/evidence projection |
